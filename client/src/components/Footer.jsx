                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : 813A, Phong Dien, Can Tho</li>
                            <li>Phone : 0939235461</li>
                            <li>Email : huyb2012210@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <ul className='flex justify-start items-center gap-3'>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaFacebookSquare /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaTwitterSquare /></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="#"><FaGithubSquare /></a>
                            </li>
                        </ul>
                    </div>
                </div>
