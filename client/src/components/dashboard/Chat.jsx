  ...
  return (
    <div className='bg-white p-3 rounded-md'>
        <div className='w-full flex relative'>
            <div className={`w-[230px] md-lg:absolute bg-white transition-all md-lg:h-full`}>
            ...
            <div className='w-[calc(100%-230px)] md-lg:w-full'>
                {
                    ...
                    <div className='flex justify-between items-center text-slate-600 text-xl h-[50px]'>
                        ...
                        <div className='w-[35px] hidden md-lg:flex cursor-pointer h-[35px] rounded-sm justify-center items-center bg-sky-600 text-white'>
                            <FaList />
                        </div>
                    </div>
                                    ...
                                    if (currentFd?.fdId !== m.receiverId) {
                                        return (
                                            <div key={i} className='w-full flex gap-2 justify-start items-center text-[14px]'>
                                                <img className='w-[30px] h-[30px] ' src="http://localhost:3000/images/seller.jpg" alt="" />
                                        ...
                                        return (
                                            <div key={i}  className='w-full flex gap-2 justify-end items-center text-[14px]'>
                                                <img className='w-[30px] h-[30px] ' src="http://localhost:3000/images/login.jpg" alt="" />
                    ...
                    <div className='border h-[40px] p-0 ml-2 w-[calc(100%-90px)] rounded-full relative'>
                        <input value={text} onChange={(e) => setText(e.target.value)}  onKeyDown={handleKeyDown} type="text" placeholder='input message' className='w-full rounded-full h-full outline-none p-3' />
