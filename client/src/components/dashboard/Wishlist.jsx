    ...
    <div className='w-full grid grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6'>
        {
             [1,2,3,4].map((p, i) => <div key={i} className='border group transition-all duration-500 hover:shadow-md hover:-mt-3 bg-white'>
                <div className='relative overflow-hidden'>
                    {
                        p.discount !== 0 && <div className='flex justify-center items-center absolute text-white w-[38px] h-[38px] rounded-full bg-red-500 font-semibold text-xs left-2 top-2'>15%</div>
                    }
                    <img className='sm:h-full w-full h-[240px]' src="http://localhost:3000/images/product/1.jpg" alt="product image" />
