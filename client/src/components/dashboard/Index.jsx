                            ...
                            <tbody>
                                {
                                    recentOrders.map((o, i) => <tr key={i} className='bg-white border-b'>
                                        ...
                                        <td scope='row' className='px-6 py-4'>
                                            ...
                                            {
                                                o.payment_status !== 'paid' && <span onClick={() => redirect(o)} className='bg-green-100 text-green-800 text-sm font-normal mr-2 px-2.5 py-[1px] rounded cursor-pointer'>PayNow</span>
                                            }
                                        </td>
                                    </tr>)
                                }
