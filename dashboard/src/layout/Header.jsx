                    ...
                    <div className='flex justify-center items-center'>
                        <div className='flex justify-center items-center gap-3'>
                            <div className='flex justify-center items-center flex-col text-end'>
                                <h2 className='text-sm font-bold'>{userInfo ? userInfo.name : 'User'}</h2>
                                <span className='text-[14px] w-full font-normal'>{userInfo ? userInfo.role : 'Guest'}</span>
                            </div>
                            {
                                userInfo && userInfo.role === 'admin' 
                                    ? <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src={adminImage} alt="" />
                                    : <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src={userInfo && userInfo.image ? userInfo.image : sellerImage} alt="" />
                            }
                        </div>
                    </div>
                </div>
