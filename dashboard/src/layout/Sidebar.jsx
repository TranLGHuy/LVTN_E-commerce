      ...
      <div className={`w-[260px] fixed bg-[#283046] z-50 top-0 h-screen shadow-[0_0_15px_0_rgb(34_41_47_/_5%)] transition-all ${showSidebar ? 'left-0':'-left-[260px] lg:left-0'}`}>
        ...
        <div className='px-[16px] pt-[15px]'>
            ...
            <ul>
                ...
                <li>
                    <button className='text-[#cfd0d2] font-normal duration-200 px-[12px] pt-[15px] py-[9px] rounded-sm flex justify-start items-center gap-[12px] hover:pl-4 transition-all w-full mb-1'>
